    ...
    for mn in results:
        ...
        for i in range(0,13):
            ...
            p.append(plt.bar(rt,ss[i],w,color=colors[i],bottom=b,
                             edgecolor="none"))
        plt.ylabel('HP remaining (Mole Rats shown as negative)')
...
def main():
    ...
    results=dict()
    mname="Ghouls Vs. Mole Rats"
    results[mname]=dict()
    results[mname]["by_victor"]=dict()

    enemylist=[ "Feral Ghoul #1", "Feral Ghoul #2", "Feral Ghoul #3",
                "Feral Ghoul #4", "Feral Ghoul #5", "Glowing One",
                "Mole Rat #1", "Mole Rat #2", "Mole Rat #3", "Mole Rat #4",
                "Mole Rat #5", "Mole Rat #6", "Mole Rat Brood Mother" ]
    ...
    for i in range(trials):
        ...
        b.add_actor_at_coords(r2.copy(),r2.coordinates.copy())
        b.add_actor_at_coords(r3.copy(),r3.coordinates.copy())
        b.add_actor_at_coords(r4.copy(),r4.coordinates.copy())
        b.add_actor_at_coords(r5.copy(),r5.coordinates.copy())
        b.add_actor_at_coords(r6.copy(),r6.coordinates.copy())
        ...
        b.add_actor_at_coords(m5.copy(),m5.coordinates.copy())
        b.add_actor_at_coords(m6.copy(),m6.coordinates.copy())
        b.add_actor_at_coords(m7.copy(),m7.coordinates.copy())
